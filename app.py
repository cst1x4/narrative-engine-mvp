...
if uploaded_file is not None:
    st.image(uploaded_file, caption="Ingested Visual Data", use_container_width=True)
    
    if st.button("Execute Narrative Generation"):
        with st.spinner("Analyzing visual data and applying CSTerrellART narrative parameters..."):
            
            base64_image = encode_image(uploaded_file)
            
            # 5. The Proprietary System Prompt & Few-Shot Training Data
            system_instruction = """
            ...
            - The fear must be entirely environmental and psychological.
            - Utilize unique, slightly melancholic animal or nature metaphors.
            - Model your pacing and tone strictly on the following three examples:
            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": system_instruction},
                    {
                        "role": "user",
                        "content": [
                            {"type": "text", "text": "Analyze this image and execute the narrative protocol."},
